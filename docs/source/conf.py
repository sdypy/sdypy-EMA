...
htmlhelp_basename = 'sdypy-EMAdoc'
...
latex_documents = [
    (master_doc, 'sdypy-EMA.tex', 'sdypy-EMA Documentation',
...
man_pages = [
    (master_doc, 'sdypy-EMA', 'sdypy-EMA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sdypy-EMA', 'sdypy-EMA Documentation',
     author, 'sdypy-EMA', 'One line description of project.',
     'Miscellaneous'),
]
